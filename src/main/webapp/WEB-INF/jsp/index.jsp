...
<link href="https://fonts.googleapis.com/css2?family=Grey+Qo&family=Playfair+Display:ital,wght@0,400..900;1,400..900&display=swap" rel="stylesheet">
        ...
        <div class="booking-container">
            ...
            <div class="trip-card">
                <div class="trip-card-content">
                    <img loading="lazy"
                         src="https://cdn.builder.io/api/v1/image/assets/TEMP/019d366101143e0b8f4895069dac87df66c465ca007eb37b0d84f5d91cd141f4?placeholderIfAbsent=true&apiKey=a1811025a09c4cc9b605f3a4595fed06"
                         class="trip-image" alt="Trip to Greece"/>
                    <h3 class="trip-title">Trip To Greece</h3>
                    <div class="trip-details">
                        <div class="trip-date">
                            <span class="trip-date-text">14-29 June</span>
                            <div class="trip-date-separator"></div>
                        </div>
                        <span class="trip-organizer">by Robbin joseph</span>
                    </div>
                    <div class="trip-footer">
                        <div class="trip-footer-left">
                            <img loading="lazy"
                                 src="https://cdn.builder.io/api/v1/image/assets/TEMP/88e8e02abc5f0bd17a29b64ef0a2f92b676cbbfbd1dc88e776bacf41e9682281?placeholderIfAbsent=true&apiKey=a1811025a09c4cc9b605f3a4595fed06"
                                 class="trip-footer-icons" alt="Trip icons"/>
                            <div class="trip-attendees">
                                <img loading="lazy"
                                     src="https://cdn.builder.io/api/v1/image/assets/TEMP/ce3d9050f95c034bad00017c325646909a9e96e7b1f271d459779b288037b2c3?placeholderIfAbsent=true&apiKey=a1811025a09c4cc9b605f3a4595fed06"
                                     class="attendees-icon" alt="Attendees icon"/>
                                <span class="attendees-count">24 people going</span>
                            </div>
                        </div>
                        <img loading="lazy"
                             src="https://cdn.builder.io/api/v1/image/assets/TEMP/1357323efe9379cd5edcdce59bb0f8ebe78a130acc3f8f4e7a75a867d5b60a74?placeholderIfAbsent=true&apiKey=a1811025a09c4cc9b605f3a4595fed06"
                             class="trip-footer-action" alt="Action icon"/>
                    </div>
                </div>
            </div>
        </div>
